...
def p(m):
    ...
    a = types.InlineKeyboardButton('Negative', url='https://telegram.me/VANDEVOORDE')
    b = types.InlineKeyboardButton('Parham', url='https://telegram.me/MOHAMMAD_FUCKR')
    c = types.InlineKeyboardButton('Arsalan', url='https://telegram.me/Developer_Sudo')
    n = types.InlineKeyboardButton('Amircc_CreeD', url='https://telegram.me/QueeNlua')
    ...
    ch = types.InlineKeyboardButton('Channel', url='https://telegram.me/forcetg_ch')
    git = types.InlineKeyboardButton('Github', url='https://github.com/force')
    markup.add(v)
    markup.add(a, j)
    markup.add(b, c)
    markup.add(n, m)
